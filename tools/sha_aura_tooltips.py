...
TEXT = {
    ...
    'hemorrhage': ('Физический урон, получаемый {path}от применившего эффект разбойника{/path}, увеличен на {path}${$s3*3}{/path}.',
                   'Physical damage taken {path}from the rogue who applied the effect{/path} increased by {path}${$s3*3}{/path}.'),
