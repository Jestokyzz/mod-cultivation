...
Статус: **кандидат разработки `v2.0.0-candidate2`, не принятый релиз**. Production-установка выполняется только после изолированного runtime-smoke и явной проверки пользователя.
