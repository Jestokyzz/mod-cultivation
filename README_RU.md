...
Статус: **v2.0.0 принят пользователем 2026-09-05 и установлен на основной сервер/клиент**. Готовый комплект прикладывается к GitHub Release. Актуальные [установка и обновление](docs/install-v2.0.0.md), [изменения](CHANGELOG_RU.md) и [область проверок](docs/audit-fixes-20260905.md). Исторические инструкции кандидатов ниже не заменяют руководство v2.0.0.
