...
В комплект включены `worldserver.exe` с модулем, шесть серверных DBC, конфигурация, SQL для свежей установки, три клиентских MPQ, исходники, manifest, SHA-256 и результаты проверок.
